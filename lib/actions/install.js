...
install.installDependencies = function (options) {
  ...
  if (options.npm !== false) {
    ...
    commands.push(cb => {
      this.npmInstall(null, getOptions(options.npm), { cwd: this.env.cwd, stdio: 'inherit' }).then(
        val => cb(null, val),
        cb
      );
    });
  ...
  if (options.yarn) {
    ...
    commands.push(cb => {
      this.yarnInstall(null, getOptions(options.yarn), { cwd: this.env.cwd, stdio: 'inherit' }).then(
        val => cb(null, val),
        cb
      );
    });
  ...
  if (options.bower !== false) {
    ...
    commands.push(cb => {
      this.bowerInstall(null, getOptions(options.bower), { cwd: this.env.cwd, stdio: 'inherit' }).then(
        val => cb(null, val),
        cb
      );
    });
